...
from application.models.models import get_embeddings, get_llm, ModelConfig
...
class TestGetEmbeddings:
    @patch("application.models.models.embeddings_factory")
...
class TestGetLlm:
    @patch("application.models.models.llm_factory")
    def test_returns_result_from_factory(self, mock_factory):
        expected = MagicMock()

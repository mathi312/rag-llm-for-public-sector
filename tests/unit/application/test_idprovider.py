...
from application.idprovider import _get_reader, _preprocess_image_for_ocr, _run_ocr_easyocr
...
@patch("application.idprovider.Reader", autospec=True)
...
@patch("application.idprovider._get_reader")
@patch("application.idprovider._preprocess_image_for_ocr")
...
@patch("application.idprovider._run_ocr_easyocr")
@patch("application.idprovider.map_id_fields")

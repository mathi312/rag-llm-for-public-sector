...
from application.documents.documentupload import upload_document
from application import pocketbase as pb
...
def test_upload_document_no_file_does_not_create(monkeypatch):
    import application.documents.documentupload as du

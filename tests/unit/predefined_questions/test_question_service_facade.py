...
from extensions.predefined_questions import (
    get_questions,
    generate_questions,
    save_questions,
...
@pytest.fixture
def mock_service():
    with patch("extensions.predefined_questions.question_service_facade.service") as mock:
        yield mock


@pytest.fixture
def mock_logger():
    with patch("extensions.predefined_questions.question_service_facade.logger") as mock:
        yield mock

...
@patch("chat.create_retrieval_chain")
@patch("chat.create_stuff_documents_chain")
def test_create_rag_chain(mock_create_stuff_documents_chain, mock_create_retrieval_chain):
    ...
    mock_create_retrieval_chain.assert_called_once()
...
class TestAnswerQuestion:
    ...
    def test_basic_answer_flow(self, mock_rag_chain):
        ...
        mock_rag_chain.invoke.assert_called_with({"input": "Was ist das?"})
    ...
    def test_with_id_uploaded(self, mock_rag_chain):
        ...
        called_args = mock_rag_chain.invoke.call_args[0][0]
